...
The RetroVMS has a builtin webserver for HTTP and HTTPS. The web UI framework provides
...
Example/template using OpenSSL::
  ...
  openssl req -x509 -newkey rsa:2048 -sha256 -days 3650 -nodes \
    -keyout RetroVMS.key -out RetroVMS.crt -subj "/CN=vehicleid.local" \
...
your current directory, ``RetroVMS.crt`` and ``RetroVMS.key``. Copy their contents
...
.. toctree::
   ...
   ../components/RetroVMS_webserver/docs/bms-cell-monitor
