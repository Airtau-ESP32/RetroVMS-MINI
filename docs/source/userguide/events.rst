...
Internally, RetroVMS raises events whenever significant events occur. An event is a lightweight message
...
``usr.<pluginname>.`` followed by the event purpose. :doc:`../components/RetroVMS_script/docs/foglight`
