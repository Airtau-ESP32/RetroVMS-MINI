...
The RetroVMS has 10 general purpose I/O ports, provided by a `MAX7317 I/O expander
...
``SW_12V`` is meant to power auxiliary devices from the RetroVMS, for example head-up displays. 
...
.. code-block:: javascript
  ...
  var input = eval(RetroVMSMetrics.AsJSON("m.egpio.input"));
